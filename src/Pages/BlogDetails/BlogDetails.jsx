...
const BlogDetails = () => {
  ...
  let { data, isLoading } = useQueryData(
    `https://tuwaiq.ezdhaar.com/api/blog/show/${id}`,
    "GET",
    "blogdetails"
  );
  ...
  const handleSubmit = (e) => {
    ...
    axios
      .post("https://tuwaiq.ezdhaar.com/api/comment/store", commentDetails)
      .then((response) => {
            ...
            <div className="container py-5">
              ...
              <article className="blog-article">
                <div className="blog-date">
                  ...
                  <h2 className="mt-2 mx-3 custom-head article-title position-relative">
                    {blogDetails?.name[lang]}
                  </h2>
            ...
            <div className="container pb-5">
              ...
              <form className="row" onSubmit={handleSubmit}>
                ...
                <div className="col-12 px-0 px-sm-1 mt-3 mb-2">
                  <button className="custom-btn z-1" type="submit">
              ...
              {blogComments?.map((comment, idx) => (
                <div key={idx} className="lite-bg p-3 mb-3 rounded">
                  <h3 className="h4 main-color fw-bold">
                    {comment?.name} <br />{" "}
                    <span className="h6">
